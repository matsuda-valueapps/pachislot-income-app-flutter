...
class _MemoPageState
  ...
  /// 保存後の画面初期化中フラグ。
  ///
  /// 保存後にTextEditingControllerを
  /// clear()した際、下書き保存Listenerが
  /// 動作するのを防ぐ。
  ...
  Future<void> _resetAfterSave() async {
    ...
    //================================================
    //
    // MainPage側でMemoPageへ接続されている
    // PrimaryScrollControllerを取得して、
    // ルート画面のスクロール位置をトップへ戻す。
    //
    // PostFrameCallbackを使用することで、
    // Controllerの状態が確定した後に
    // スクロール位置を変更する。
    //================================================
